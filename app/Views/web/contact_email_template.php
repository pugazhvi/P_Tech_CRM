  ...
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,700" rel="stylesheet" />
	...
	<style type="text/css">
		...
		@media screen and (max-width: 599px) {
		   ...
		   td.centerText{text-align: left!important;}
	...
	<tr>
		<td class="bodyBgColor" align="center" valign="top" bgcolor="#F5F5F5">
			...
			<table class="row" border="0" width="700" align="center" cellpadding="0" cellspacing="0" style="width:700px;max-width:700px;">
				<tr>
					<td class="greyBgColor" align="center" valign="top" bgcolor="#F5F5F5">
																...
																<tr>
																	<td align="left" valign="middle">
																		<table border="0" align="left" cellpadding="0" cellspacing="0">
																			<tr>
																				<td class="coTitle centerText" align="left" valign="middle" style="font-family:'Montserrat',Arial,Helvetica,sans-serif;color:#191919;font-size:16px;line-height:26px;font-weight:600;letter-spacing:0px;padding:0;padding-bottom:5px;">
															...
															<table width="100%" class="row" border="0" cellpadding="0" cellspacing="0" align="center">
																<tr>
																	<td align="left" valign="middle">
																		<table border="0" align="left" cellpadding="0" cellspacing="0">
																			<tr>
																				<td class="coDescription" align="left" valign="middle" style="font-family:'Montserrat',Arial,Helvetica,sans-serif;color:#6f6f6f;font-size:14px;line-height:26px;font-weight:400;letter-spacing:0px;">
																					Lorem ipsum dolor sit ametcon, sectetur adipiscing elit PhasellusLorem ipsum dolor sit ametcon, sectetur adipiscing elit Phasellus.
																				</td>
																			</tr>
																		</table>
																	</td>
