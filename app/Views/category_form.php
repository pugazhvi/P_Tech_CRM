    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="page-title-box page-title-box-alt">
                    <h4 class="page-title">
                     ...
                     <?php if(isset($categoryData)){ echo 'Edit Category'; }else{ echo 'Create Category'; } ?>
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <form method="post" 
                    <?php if(isset($categoryData)){ ?>  action="<?= base_url()."category_edit"; ?>"
                    <?php } else {  ?>   action="<?= base_url()."category_create"; ?>" <?php } ?>
                     class="parsley-examples">


                     <?php if(isset($categoryData)){ ?>
                            <input type="hidden" required   name="id" value="<?= $categoryData->id; ?>" id='id' >
                    <?php } ?>
                ...
                <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="category"  parsley-trigger="change" required  class="form-control" id="category" value="<?php if(isset($categoryData)){ echo $categoryData->category; } ?>">
                        </div>
