...
class NotesModel extends Model
{
	...
	protected $allowedFields = ['visa_request_id' , 'status' , 'awb_no' , 'is_visa_approved' , 'notes' , 'is_active', 'file' ,'created_by','updated_by'];
    ...
    public function getVisaRequestNotes($visa_request_id)
    {
         $result =  $this->db->table('visa_request_notes')
                         ...
                         ->where('md5(visa_request_notes.visa_request_id)',$visa_request_id)
